...
- [ ] **Phase 1: Foundation + IDE Shell** - Scaffold + dark IDE chrome live on a public Vercel URL
...
|-------|----------------|--------|-----------|
| 1. Foundation + IDE Shell | 0/TBD | Not started | - |
| 2. Resume & About Layer | 0/TBD | Not started | - |
